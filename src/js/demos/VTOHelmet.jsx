  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          <ThreeGrabber sizing={{width: 800, height: 600}} lighting={_settings.lighting} />
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <VTOButton onClick={setModel.bind(null, GLTFModel2)}>🏍️ Motorcycle Helmet</VTOButton>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <VTOButton onClick={capture_image}>📸 Capture Photo</VTOButton>
          </div>
        </div>
      </div>
    </div>
